# InstrumentStudio Plug-In SDK Reference
...
Call this VI with the Session Id as the first SDK call at the beginning of your
...
Below is an example of registering for and handling the Project Saved event. If
